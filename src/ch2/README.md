...
$$
\text{新的像素值} = \frac{\sum(\text{邻域像素值} \times \text{对应权重})}{\sum \text{所有权重}}
$$
...
AI 就是这样用的嘛，对吧，用 AI 满足自己的好奇心和探索欲望。与其说是满足，其实更多的是种“保护”，当你发现你有一个永远耐心和鼓励的老师，探索未知就不再那么恐怖。确信知识就在那里等着你去问，这种安全感太棒了！

无论是任何领域，专业课，计算机科学之外的世界，希望大家能有探索的勇气和决心，不要怀疑自己的能力，你已经做得很好了，就是缺一点点时间。

### 什么是 SSIM

回到主题。我们现在有一张没有经过滤波的原图，和一张经过滤波的图片，我们怎么知道滤波的效果就更好呢？放心，以前的科学家想出来一套办法，用来衡量我们滤波的效果。
...
在 ch2 的实验中，我们已经提供好了 SSIM 的公式，作为框架代码，大家需要做的就是计算方差和协方差这两步。
